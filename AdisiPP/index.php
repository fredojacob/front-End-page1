...
<head>
    ...
    <title>Adisi GT, S.A.</title>
    <meta name="description" content="Pagina Publicitaria de Adisi GT">
    <meta name="author" content="Luis Pierri">
...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">ADISI GT</a> </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#features" class="page-scroll">Caracterisitcas</a></li>
                <li><a href="#about" class="page-scroll">Quienes Somos</a></li>
                <li><a href="#services" class="page-scroll">Servicios</a></li>
                <li><a href="#portfolio" class="page-scroll">Galeria de Apps</a></li>
                <li><a href="#testimonials" class="page-scroll">Que opinan de Nosotros</a></li>
...
<div id="features" class="text-center">
    <div class="container">
        <div class="col-md-10 col-md-offset-1 section-title">
            <h2>Caracteristicas que nos identifican</h2>
        </div>
        <div class="row">
            <div class="col-xs-6 col-md-4"> <i class="fa fa-comments-o"></i>
                <h3>Comunicacion Efectiva</h3>
                <p> La comunicacion con nuestros clientes es de suma importancia, para esto se establecen tres canales directos para que el cliente siempre este enterado de su proyecto y asi mismo pueda hacer las consultas que necesite al equipo tecnico.</p>
            </div>
            <div class="col-xs-6 col-md-4"> <i class="fa fa-bullhorn"></i>
                <h3>Capacitacíon Constante</h3>
                <p>Todo nuestro equipo se tiene un tiempo diario asignado a capacitacion de nuevas herramientas para poder ofrecer siempre nuevas tecnologias a las soluciones de nuestros clientes.</p>
            </div>
            <div class="col-xs-6 col-md-4"> <i class="fa fa-group"></i>
                <h3>Trabjo en Equipo</h3>
                <p>El trabajo en equipo entre nuestros equipos y nuestros clientes es escencial en toda toma de decision siempre deben de estar presentes dos personas de cada equipo.</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class=" embed-responsive embed-responsive-4by3">
                    <iframe class="embed-responsive-item" src=".\img\Reveal01.mp4" ></iframe>
                </div>
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="about-text">
                    <h2>Quienes Somos</h2>
                    <p>Somos una empresa dedicada a la elaboracion de aplicaciones moviles, para mejorar, optimizar y evolucionar los procesos de nuestros clientes, optimizando el recurso humano y asi poder explotar el tiempo de cada uno de sus empleados.</p>
                    <h3>Por qué elegirnos?</h3>
                    <div class="list-style">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <ul>
                                <li>Entrega en tiempo establecido</li>
                                <li>Comunicacion Constate</li>
                                <li>Actualizacion de Procesos </li>
                                <li>Estamos a la vanguardia de las Nuevas tecnologia</li>
                                <li>Facilidades de Pago</li>
                                <li>Total Confidencialidad de su informacion</li>
                                <li></li>
                                <li></li>
                            </ul>
                        </div>
...
<div id="contact">
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" id="name" class="form-control" placeholder="Nombre Completo / Empresa" required="required">
        ...
        <div class="col-md-3 col-md-offset-1 contact-info">
            ...
            <div class="contact-item">
                <p><span><i class="fa fa-phone"></i> Telefono</span> +502 5946 1188</p>
            </div>
            <div class="contact-item">
                <p><span><i class="fa fa-envelope-o"></i> Email</span> contacto@adisigt.com</p>
            </div>
        </div>
        <div class="col-md-12">
            <div class="row">
...
<div id="footer">
    <div class="container text-center">
        <p>&copy; 2017.  Diseñado por <a href="http://www.adisigt.com" rel="nofollow">Adisi GT</a></p>
    </div>
</div>
